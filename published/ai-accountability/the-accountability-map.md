...
owns, how it's distinct from the roles beside it, and how to do the job. A role is added
to the map only once it's been researched and authored — this page names the roles the
domain intends to cover, but a role without a link below isn't written yet.
...
- **[Chief AI Officer](/ai-accountability/chief-ai-officer/index.md)** — sets the AI
  ...
  holds the budget.
- **[AI Transformation Lead](/ai-accountability/ai-transformation-lead/index.md)** — runs
...
- **[AI Enablement Lead](/ai-accountability/ai-enablement/index.md)** — accountable for one
