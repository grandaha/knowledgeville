...
verified:
  - by: "human:daveraffaele"
    at: "2026-07-06T00:00:00Z"
sources:
  - id: ev-checkpoint-2026-claude-code-key-exfiltration-cve
    resource: "https://research.checkpoint.com/2026/rce-and-api-token-exfiltration-through-claude-code-project-files-cve-2025-59536/"
    title: "Caught in the Hook: RCE and API Token Exfiltration Through Claude Code Project Files"
    author: Check Point Research
  - id: ev-trapdoor-2026-ai-assistant-config-poisoning
    resource: "https://socket.dev/blog/trapdoor-crypto-stealer-npm-pypi-crates"
    title: TrapDoor Crypto Stealer Supply Chain Attack Hits 34 Packages
    author: Socket Research Team
  - id: ev-maloyan-2026-agentic-coding-injection-sok
    resource: "https://arxiv.org/abs/2601.17548"
    author: Maloyan
# okf:generated:end
---
