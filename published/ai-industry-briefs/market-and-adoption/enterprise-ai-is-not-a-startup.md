---
type: Reference
title: Enterprise AI Is Not a Startup
description: "Aaron Levie's case that real AI transformation happens in the 88% of the economy constrained by legacy systems and regulation, not model quality."
resource: "https://www.horsesforsources.com/aaron-levie_060626/"
...
- **Link:** [https://www.horsesforsources.com/aaron-levie_060626/](https://www.horsesforsources.com/aaron-levie_060626/)
...
1. **Tech is a slice, not the whole.** Levie notes the tech industry is about **10-12% of GDP** ([HFS, 2026](#ev-hfs-levie-enterprise-ai-2026)). Most of the AI conversation happens inside that slice, among companies already built to adopt it.

2. **The other 88% runs on different rules.** "The other 88% is where the transformation happens" ([HFS, 2026](#ev-hfs-levie-enterprise-ai-2026)). Those companies are held back by legacy systems, regulation, and thin resources, not by how clever the model is.
...
4. **Humans do not leave the loop; they move.** As Levie puts it, we have not removed humans from the loop, we have changed where they enter it. That creates a new job category — people who run and supervise agents — which he sizes at **500,000 to a million roles** <!-- noev: same HFS source, already anchored above -->.

5. **This grows the budget, it does not shrink it.** Levie's view is that this "probably doubles global enterprise technology spend" by tying investment directly to workflow productivity <!-- noev: same HFS source -->. AI becomes a new category of investment, not a cost cut.

6. **Point the best models where they pay off.** His prescription: identify the **5-10%** of your workforce doing the highest-value work, and give them the best models with no capacity limits <!-- noev: same HFS source -->.
...
- The tech industry is **10-12% of GDP**; "the other 88% is where the transformation happens" ([HFS, 2026](#ev-hfs-levie-enterprise-ai-2026)). *(Levie's figure and Fersht's framing; the 88% is the rhetorical complement, not a measured statistic.)*
- A new category of agent-operator work, sized at **500,000 to a million roles** ([HFS, 2026](#ev-hfs-levie-enterprise-ai-2026)). *(Levie's projection about the future, not a current count.)*
- AI "probably doubles global enterprise technology spend" ([HFS, 2026](#ev-hfs-levie-enterprise-ai-2026)). *(Levie's estimate; no model or source is shown for it.)*
- Give the best models to the **5-10%** of the workforce doing the highest-value work ([HFS, 2026](#ev-hfs-levie-enterprise-ai-2026)). *(Levie's prescription, not a benchmark.)*
