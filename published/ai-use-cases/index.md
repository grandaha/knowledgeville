...
Two sub-domains are live today. **[Everyday Tasks](/ai-use-cases/everyday-tasks/index.md)** is copy-paste recipes for everyday work, written for someone who just wants to get something done with an AI chat tool, with no technical setup. **[Executive Leadership](/ai-use-cases/executive-leadership/index.md)** is AI recipes and workflows for the C-suite — board updates, budget reviews, org calls, and the messages that can't land wrong.
