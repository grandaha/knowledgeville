...
sources:
  ...
  - id: ev-mckinsey-oxford-it-projects-2012
    resource: "https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/delivering-large-scale-it-projects-on-time-on-budget-and-on-value"
    title: "Delivering large-scale IT projects on time, on budget, and on value"
    author: "McKinsey & Company with the BT Centre for Major Programme Management, University of Oxford"
  - id: ev-openai-finetuning-2026-api-only-access
    resource: "https://developers.openai.com/api/docs/guides/supervised-fine-tuning"
    title: Supervised fine-tuning (API docs)
    author: OpenAI
  - id: ev-openai-deprecations-2026-notice-and-cutoff
    ...
    author: OpenAI
  - id: ev-openai-pricing-2026-per-token
    resource: "https://developers.openai.com/api/docs/pricing"
    title: Pricing (API docs)
    author: OpenAI
  - id: ev-anthropic-reduce-hallucinations-2026-standing-risk
    resource: "https://platform.claude.com/docs/en/docs/test-and-evaluate/strengthen-guardrails/reduce-hallucinations"
