...
- **Let evidence pace the spend.** Effort is ~70% people and process ([BCG, 2025](#ev-bcg-value-gap-2025-ten-twenty-seventy)); fund the constraint, prove the value, and reallocate quarterly on what the [measurement](/enterprise-ai-transformation/tracks/08-measurement-and-value-realization/index.md) shows.
