...
sources:
  ...
  - id: ev-mckinsey-state-of-ai-2026-scaling-by-size
    ...
    author: McKinsey
  - id: ev-oecd-2025-firm-size-adoption-gap
    resource: "https://www.oecd.org/en/publications/2025/12/ai-adoption-by-small-and-medium-sized-enterprises_9c48eae6.html"
    title: AI adoption by small and medium-sized enterprises
    author: OECD
  - id: ev-goldman-sachs-2025-smb-resource-gap
    resource: "https://www.goldmansachs.com/community-impact/10000-small-businesses-voices/insights/ai-presents-a-major-opportunity-for-small-businesses"
    title: "10,000 Small Businesses Voices (AI survey)"
    author: Goldman Sachs
  - id: ev-mit-nanda-genai-divide-2025-buy-vs-build
    resource: "https://mlq.ai/media/quarterly_decks/v0.1_State_of_AI_in_Business_2025_Report.pdf"
    title: "The GenAI Divide: State of AI in Business 2025"
    author: MIT Project NANDA
  - id: ev-idc-2024-deployment-and-time-to-value
...
**Profile.** Many business units, established (often regulated) governance, deep legacy data estates, thousands of employees, competing internal agendas. The hard problem is not capability but coordination: scaling across units without either fragmenting into uncoordinated pilots or collapsing under central-program overhead. In McKinsey's 2026 survey, 54% of companies with $1 billion or more in revenue were scaling AI enterprise-wide, against a third of smaller ones ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-scaling-by-size)). They have the resources, but also the most surface area to coordinate.
...
**Binding constraint.** Adoption and proof. The technology and the workflow are well understood; what decides success is whether the function's people actually change how they work, and whether the win is measured credibly enough to defend and expand. In McKinsey's earlier 2025 survey, only about 21% of gen-AI users had fundamentally redesigned at least some workflows ([McKinsey, 2025](#ev-mckinsey-state-of-ai-2025-workflow-redesign)). By 2026, nearly three-quarters of high performers had fundamentally redesigned workflows, against one-quarter of other organizations ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-workflow-redesign-highperf)).
