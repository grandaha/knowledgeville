...
**Binding constraint.** Adoption and proof. The technology and the workflow are well understood; what decides success is whether the function's people actually change how they work, and whether the win is measured credibly enough to defend and expand. In McKinsey's earlier 2025 survey, only about 21% of gen-AI users had redesigned any workflow; most simply layered AI on top of existing process ([McKinsey, 2025](#ev-mckinsey-state-of-ai-2025-workflow-redesign)). By 2026, nearly three-quarters of high performers had fundamentally redesigned workflows, against one-quarter of other organizations ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-workflow-redesign-highperf)).
