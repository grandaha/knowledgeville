...
- **The first 90 days set the trajectory.** Aim for one or two *measured* use cases, not many unmeasured ones — only about 5% of companies achieve AI value at scale ([BCG, 2025](#ev-bcg-value-gap-2025-distribution)), and at least 30% of gen-AI projects are projected to be abandoned after PoC ([Gartner, 2024](#ev-gartner-genai-poc-2024-abandonment)).
