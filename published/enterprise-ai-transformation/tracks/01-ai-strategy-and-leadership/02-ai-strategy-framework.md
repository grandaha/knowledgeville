...
> **>80%** of AI projects fail — roughly twice the failure rate of non-AI IT projects, with the leading root cause being misunderstood or miscommunicated intent and purpose, not technical limitations ([RAND, 2024](#ev-rand-ai-projects-fail-2024-failure-rate))
> **95%** of organizations are getting zero return on generative-AI investment; only **5%** of integrated AI pilots are extracting real value ([MIT Project NANDA, 2025](#ev-mit-nanda-genai-divide-2025-no-pl-impact)), against an estimated **$30–40 billion** of enterprise GenAI investment ([MIT Project NANDA, 2025](#ev-mit-nanda-genai-divide-2025-enterprise-investment))
...
> **$644 billion** in worldwide generative-AI spending is forecast for 2025, up **76.4%** from 2024 ([Gartner, 2025](#ev-gartner-genai-spending-2025-worldwide-forecast)); total worldwide AI spending is forecast at nearly **$1.5 trillion** for 2025 ([Gartner, 2025](#ev-gartner-ai-spending-2025-worldwide-total))
...
> Only **32%** of enterprises actively using AI have a holistic, organization-wide AI strategy; another **27%** have one only for limited or specific use cases, and **32%** are still developing one — leaving the rest with no enterprise strategy at all ([IBM, 2023](#ev-ibm-ai-adoption-index-2023-strategy-split))
...
> **8%** of companies ("front-runners") are scaling AI at an enterprise level and embedding it into core business strategy ([Accenture, 2025](#ev-accenture-front-runners-2025-eight-percent)); companies scaling just **one** strategic AI bet are nearly **3x** more likely to exceed their ROI expectations ([Accenture, 2025](#ev-accenture-front-runners-2025-roi-3x))
...
> Enterprises recognize AI risks more than they mitigate them — cybersecurity (**66%** relevant), regulatory compliance (**63%**), and privacy (**60%**) top the list, but mitigation lags in every category (e.g., IP infringement **57%** relevant vs **38%** mitigated) ([Stanford HAI, 2025](#ev-stanford-hai-ai-index-2025-rai-risk-gap)); only **14%** of organizations report dedicated AI-governance roles ([Stanford HAI, 2025](#ev-stanford-hai-ai-index-2025-governance-roles))
...
> **31%** of organizations say they are not ready to deploy AI — down from 41% the prior year ([Deloitte, 2025](#ev-deloitte-governance-ai-2025-not-ready-to-deploy))
...
> **74%** of companies have yet to show tangible value from AI; only **26%** have moved beyond proofs of concept to generate tangible value ([BCG, 2024](#ev-bcg-value-2024-beyond-poc))
> **39%** of organizations attribute any EBIT impact to AI, and for most that impact is under **5%** ([McKinsey, 2025](#ev-mckinsey-state-of-ai-2025-ebit-any)); only **~6%** are high performers attributing more than **5%** of EBIT to AI, and nearly two-thirds have not yet begun scaling AI across the enterprise ([McKinsey, 2025](#ev-mckinsey-state-of-ai-2025-high-performers))
...
> **15%** of organizations using generative AI report already achieving significant, measurable ROI; only **10%** see significant measurable ROI from agentic AI ([Deloitte, 2025](#ev-deloitte-ai-roi-paradox-2025-measurable-roi)); **85%** increased AI investment in the past year and **91%** plan to increase it again — even though AI payback periods run longer than the **7–12 months** typical of technology investments ([Deloitte, 2025](#ev-deloitte-ai-roi-paradox-2025-investment-and-payback))
...
> **28%** of organizations using AI report that their CEO is responsible for overseeing AI governance; **17%** say their board of directors oversees it ([McKinsey, 2025](#ev-mckinsey-rewiring-2025-ceo-oversight))

The trend, at least, points the right way.

> **31%** of board directors say AI is not on the board agenda, down from **45%** the prior year ([Deloitte, 2025](#ev-deloitte-governance-ai-2025-board-agenda))
...
> At least **30%** of generative-AI projects will be abandoned after proof of concept by the end of 2025 — due to poor data quality, inadequate risk controls, escalating costs, or unclear business value ([Gartner, 2024](#ev-gartner-genai-poc-2024-abandonment))
> The share of companies abandoning most of their AI initiatives rose to **42%**, up from **17%** a year earlier; the average organization scrapped **46%** of AI proofs-of-concept before they reached production ([S&P Global Market Intelligence, 2025](#ev-sp-global-vote-2025-abandoned-ai-initiatives))
...
- **MIT Project NANDA — *The GenAI Divide: State of AI in Business 2025*, 2025.** Despite $30-40 billion in enterprise investment into GenAI, 95% of organizations are getting zero return. [View source](https://mlq.ai/media/quarterly_decks/v0.1_State_of_AI_in_Business_2025_Report.pdf){#ev-mit-nanda-genai-divide-2025-enterprise-investment} · verified 2026-06-21 · ⚠ secondary mirror
- **Gartner — *Gartner Forecasts Worldwide GenAI Spending to Reach $644 Billion in 2025*, 2025.** Worldwide generative AI (GenAI) spending is expected to total $644 billion in 2025, an increase of 76.4% from 2024. [View source](https://www.gartner.com/en/newsroom/press-releases/2025-03-31-gartner-forecasts-worldwide-genai-spending-to-reach-644-billion-in-2025){#ev-gartner-genai-spending-2025-worldwide-forecast} · verified 2026-06-21 · ⚠ secondary mirror
- **Gartner — *Gartner Says Worldwide AI Spending Will Total $1.5 Trillion in 2025*, 2025.** Worldwide spending on AI is forecast to total nearly $1.5 trillion in 2025, with the AI market growing almost 50% year over year. [View source](https://www.gartner.com/en/newsroom/press-releases/2025-09-17-gartner-says-worldwide-ai-spending-will-total-1-point-5-trillion-in-2025){#ev-gartner-ai-spending-2025-worldwide-total} · verified 2026-06-21 · ⚠ secondary mirror
- **IBM — *IBM Global AI Adoption Index - Enterprise Report*, 2023.** 27% reporting that their company has an AI strategy for limited/specific use cases and about a third (32%) stating that their organization already has a holistic strategy in place; 32% are in the process of developing an AI strategy. [View source](https://filecache.mediaroom.com/mr5mr_ibmspgi/179414/download/IBM%20Global%20AI%20Adoption%20Index%20Report%20Dec.%202023.pdf){#ev-ibm-ai-adoption-index-2023-strategy-split} · verified 2026-06-21 · primary
- **Accenture — *The Front-Runners' Guide to Scaling AI: Lessons from industry leaders*, 2025.** Only 8% of companies are front-runners, scaling AI at an enterprise level and embedding it into core business strategy. [View source](https://www.accenture.com/us-en/insights/ai-data/front-runners-guide-scaling-ai){#ev-accenture-front-runners-2025-eight-percent} · verified 2026-06-21 · primary
- **Accenture — *The Front-Runners' Guide to Scaling AI: Lessons from industry leaders*, 2025.** companies that have scaled at least one strategic bet are nearly three times more likely to have their return on investment (ROI) from gen AI surpass their forecasts. [View source](https://www.accenture.com/us-en/insights/ai-data/front-runners-guide-scaling-ai){#ev-accenture-front-runners-2025-roi-3x} · verified 2026-06-21 · primary
- **Stanford HAI (Institute for Human-Centered AI) — *2025 AI Index Report, Chapter 3: Responsible AI (data: McKinsey 2024 RAI survey)*, 2025.** Cybersecurity (66%), regulatory compliance (63%), and personal privacy (60%) rank as the top concerns, yet mitigation efforts consistently fall short; the gap is particularly pronounced for intellectual property infringement (57% relevant, 38% mitigated). [View source](https://hai.stanford.edu/ai-index/2025-ai-index-report/responsible-ai){#ev-stanford-hai-ai-index-2025-rai-risk-gap} · verified 2026-06-21 · ⚠ secondary mirror
- **Stanford HAI (Institute for Human-Centered AI) — *2025 AI Index Report, Chapter 3: Responsible AI (data: McKinsey 2024 RAI survey)*, 2025.** 14% of respondents reported having dedicated AI governance roles, signaling growing recognition of AI governance as a distinct and essential function. [View source](https://hai.stanford.edu/ai-index/2025-ai-index-report/responsible-ai){#ev-stanford-hai-ai-index-2025-governance-roles} · verified 2026-06-21 · ⚠ secondary mirror
- **Deloitte Global — *Governance of AI: A critical imperative for today's boards (2nd edition)*, 2025.** almost one-third of respondents (31%) say their organizations are not ready to deploy AI; in the previous survey, that figure was 41 percent. [View source](https://www.deloitte.com/global/en/issues/trust/progress-on-ai-in-the-boardroom-but-room-to-accelerate.html){#ev-deloitte-governance-ai-2025-not-ready-to-deploy} · verified 2026-06-21 · primary
...
- **Deloitte — *AI ROI: The paradox of rising investment and elusive returns (EMEA; 1,854 executives)*, 2025.** Fifteen percent of respondents using generative AI report their organizations already achieve significant, measurable ROI; only ten percent currently see significant, measurable ROI from agentic AI. [View source](https://www.deloitte.com/global/en/issues/generative-ai/ai-roi-the-paradox-of-rising-investment-and-elusive-returns.html){#ev-deloitte-ai-roi-paradox-2025-measurable-roi} · verified 2026-06-21 · primary
- **Deloitte — *AI ROI: The paradox of rising investment and elusive returns (EMEA; 1,854 executives)*, 2025.** 85 percent of organizations increased their investment in the past 12 months and 91 percent plan to increase it again this year; most achieved satisfactory ROI within two to four years, significantly longer than the typical payback period of seven to 12 months expected for technology investments. [View source](https://www.deloitte.com/global/en/issues/generative-ai/ai-roi-the-paradox-of-rising-investment-and-elusive-returns.html){#ev-deloitte-ai-roi-paradox-2025-investment-and-payback} · verified 2026-06-21 · primary
