...
| **10-20-70 principle** | A rule of thumb for where to put strategic focus: 70% on people and processes, 20% on technology, 10% on algorithms. Use when setting transformation budgets and where to weight change management. | Boston Consulting Group (BCG) |
