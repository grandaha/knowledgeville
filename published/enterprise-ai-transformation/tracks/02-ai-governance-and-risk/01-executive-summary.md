...
sources:
  - id: ev-pex-network-2025-ai-governance-policy
    resource: "https://www.processexcellencenetwork.com/business-transformation/reports/pex-report-global-state-process-excellence"
    title: PEX Report 2025/26 (Global State of Process Excellence)
    author: PEX Network
  - id: ev-deloitte-governance-ai-2025-board-knowledge-gap
  ...
  - id: ev-ibm-2025-ai-breaches-controls
    resource: "https://newsroom.ibm.com/2025-07-30-ibm-report-13-of-organizations-reported-breaches-of-ai-models-or-applications,-97-of-which-reported-lacking-proper-ai-access-controls"
    title: Cost of a Data Breach Report 2025
    author: IBM (Ponemon Institute)
  - id: ev-eu-ai-act-2024-article-99-penalties
    resource: "https://artificialintelligenceact.eu/article/99/"
    title: "Regulation (EU) 2024/1689 (AI Act), Article 99"
  ...
  - id: ev-fenergo-financial-penalties-2024-us-regulators
    resource: "https://resources.fenergo.com/newsroom/fenergo-study-regulatory-penalties-in-north-america-account-for-95-of-global-financial-penalties-in-2024"
    title: Financial-crime / AML enforcement penalties study (full-year 2024)
    author: Fenergo
  ...
  - id: ev-mitsmr-cisr-2025-ai-savvy-boards-roe
    resource: "https://sloanreview.mit.edu/article/ai-savvy-boards-drive-superior-performance/"
    title: AI-Savvy Boards Drive Superior Performance
    author: MIT Sloan Management Review / MIT CISR
# okf:generated:end
---
...
**Regulatory compliance.** The EU AI Act is the most structurally significant regulation, and it is not the only one that binds. Sector-specific rules in financial services (model risk management guidance from the OCC, FRB, and FDIC) and healthcare apply, and so does US employment law. New York City has required an annual independent bias audit of automated employment decision tools since 2023 ([NYC DCWP, 2023](#ev-nyc-ll144-2023-annual-bias-audit)). Illinois has made discriminatory AI use across the employment lifecycle a civil rights violation ([Illinois, 2026](#ev-illinois-hb3773-2026-ai-employment-discrimination)). Organizations with global operations face overlapping requirements. Compliance requires mapping each AI deployment to the applicable regulatory category, documenting how it meets requirements, and maintaining that documentation as models and regulations evolve.
...
- Establish or formally charter an AI governance function — even a lightweight one — before the EU AI Act's high-risk obligations apply in December 2027. The gap to close is between "working on it" and "formally accountable."
