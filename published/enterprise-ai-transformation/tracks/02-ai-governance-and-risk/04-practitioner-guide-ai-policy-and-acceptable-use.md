...
- **High-risk system requirements** (Annex III) were originally set to take full effect August 2, 2026. The EU's AI Omnibus, in force since July 27, 2026, postponed them. Stand-alone Annex III systems now face them from December 2, 2027. AI embedded in regulated products under Annex I faces them from August 2, 2028 ([European Commission, 2026](#ev-ec-ai-act-2024-application-timeline)). High-risk categories include: biometric identification and categorization, management of critical infrastructure, education and vocational training, employment and worker management, access to essential private services (credit, insurance), law enforcement, migration and border management, and administration of justice. Systems in these categories require conformity assessments, technical documentation, human oversight mechanisms, and in some cases registration in the EU database before deployment.
