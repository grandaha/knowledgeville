...
3. **Federal Reserve SR 11-7** — *Guidance on Model Risk Management* (April 2011). Foundational framework for model inventory, independent validation, and model risk governance in financial institutions. Broadly applied by analogy across sectors. [https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm](https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm)
