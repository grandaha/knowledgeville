...
sources:
  - id: ev-rand-ai-projects-fail-2024-failure-rate
    ...
    author: RAND
  - id: ev-ibm-ibv-2024-data-readiness-bar
    resource: "https://www.ibm.com/think/topics/ai-ready-data"
    title: What Is AI-Ready Data? (citing a 2024 IBV survey)
  ...
  - id: ev-data-quality-cost-3-1-trillion-us
    ...
    author: IBM
  - id: ev-gartner-ai-ready-data-2025-abandonment
    resource: "https://www.gartner.com/en/newsroom/press-releases/2025-02-26-lack-of-ai-ready-data-puts-ai-projects-at-risk"
...
Unaddressed *data debt* behaves like financial debt: it accrues interest. Every new AI system deployed on ungoverned data multiplies the impact — one wrong model is bounded; dozens of agents acting continuously on inconsistent data are not. Data volume growth, AI deployment growth, and tightening regulation each raise the bill. EU AI Act high-risk obligations apply from December 2027, or August 2028 for AI built into regulated products ([European Commission, 2026](#ev-ec-ai-act-2024-application-timeline)). IDC projects that CIOs who defer remediation face **50% higher AI failure rates** by 2027 ([IDC, 2026](#ev-idc-futurescape-2026-data-debt-failure)). The foundation will never be cheaper to fix than it is today.
