...
> Only about **13%** of organizations are in Cisco's most AI-ready tier, a share that has held steady for three years. Readiness, not ambition, is the constraint ([Cisco, 2025](#ev-cisco-ai-readiness-2025-pacesetters))

> Fewer than half (**44%**) of organizations using AI are scaling it across the enterprise ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-scaling-by-size)).
> Larger companies lead: 54% of those with $1 billion or more in revenue are scaling AI enterprise-wide, against a third of smaller ones ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-scaling-by-size))

> BCG's **10-20-70** rule: focus 10% of the effort on algorithms, 20% on technology and data, and **70% on people and process** ([BCG, 2025](#ev-bcg-value-gap-2025-ten-twenty-seventy))
