...
sources:
  ...
  - id: ev-ey-get-ready-for-robots-2016-rpa-failure-rate
    ...
    author: EY
  - id: ev-abbyy-2020-rpa-failure-reasons
    resource: "https://www.ciodive.com/news/rpa-robotic-process-automation-failures/577917/"
    title: ABBYY survey of 400 senior executives on RPA (reported via CIO Dive)
    author: ABBYY
  - id: ev-deloitte-global-rpa-survey-2018-scaling
    ...
    author: Deloitte
  - id: ev-apqc-pcf-2018-hierarchy
    resource: "https://www.apqc.org/sites/default/files/files/PCF%20Collateral/Understanding%20the%20PCF%20Elements%20%20-%20FINAL.pdf"
    title: "Understanding the Elements of APQC's Process Classification Framework (PCF)"
    author: APQC
  - id: ev-mckinsey-mgi-economic-potential-2023-time-automation
  ...
  - id: ev-arxiv-rpa-viability-2020-screening-criteria
    resource: "https://arxiv.org/abs/2007.10900"
    title: A framework to evaluate the viability of robotic process automation for business process activities
    author: "Wellmann, Stierle, Dunzer & Matzner (arXiv)"
  ...
  - id: ev-gartner-ai-agents-2025-enterprise-apps
    resource: "https://www.gartner.com/en/newsroom/press-releases/2025-08-26-gartner-predicts-40-percent-of-enterprise-apps-will-feature-task-specific-ai-agents-by-2026-up-from-less-than-5-percent-in-2025"
    title: "Gartner Predicts 40% of Enterprise Apps Will Feature Task-Specific AI Agents by 2026"
    author: Gartner
  - id: ev-ieee-process-mining-manifesto-2012-definition
    resource: "https://www.tf-pm.org/upload/1580737614108.pdf"
    title: Process Mining Manifesto
    author: IEEE Task Force on Process Mining
  - id: ev-forrester-celonis-tei-2025-roi
    resource: "https://tei.forrester.com/go/celonis/processIntelligence/docs/TheTEIOfCelonis.pdf"
    title: The Total Economic Impact of Celonis
    author: Forrester Consulting (commissioned by Celonis)
  - id: ev-celonis-customer-stories-named-results
    resource: "https://www.celonis.com/solutions/stories/deutsche-telekom-procure-to-pay-process-mining"
    title: Customer Stories (Deutsche Telekom procure-to-pay; GE Healthcare cash flow)
    author: Celonis
  - id: ev-mckinsey-mgi-economic-potential-2023-value-by-function
    resource: "https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier"
    title: "The economic potential of generative AI: The next productivity frontier"
    author: McKinsey (McKinsey Global Institute)
  - id: ev-klarna-2024-assistant-resolution
    ...
    author: Klarna
  - id: ev-idc-business-value-genai-2024-roi-per-dollar
    resource: "https://blogs.microsoft.com/blog/2024/11/12/idcs-2024-ai-opportunity-study-top-five-ai-trends-to-watch/"
    title: "The Business Opportunity of AI (IDC InfoBrief, sponsored by Microsoft)"
    author: IDC
  - id: ev-google-cloud-roi-2025-first-year-roi
    resource: "https://cloud.google.com/transform/roi-of-ai-how-agents-help-business"
...
Enterprises have crossed the adoption threshold for AI but not the value threshold. By mid-2026, **89% of organizations reported regular AI use in at least one business function**, up from 78% in 2024 ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-adoption)). Yet adoption has badly outrun realized return. In the same survey, **only 37% of organizations could attribute any enterprise-level EBIT impact to AI** ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-ebit-any)). The work has been deployed almost everywhere and is paying off almost nowhere at scale.
...
- **Optimizing the task, ignoring the workflow.** Deploying a faster tool inside an unchanged process. Task-level gains do not reach the P&L until the surrounding workflow is redesigned; this is the core of the 37%-EBIT-impact gap. <!-- noev: restates the 37% EBIT figure anchored above -->
