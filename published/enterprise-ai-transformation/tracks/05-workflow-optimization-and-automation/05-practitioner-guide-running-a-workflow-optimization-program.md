...
sources:
  ...
  - id: ev-mckinsey-future-that-works-2017-automatable-activities
    resource: "https://www.mckinsey.com/featured-insights/digital-disruption/harnessing-automation-for-a-future-that-works"
    title: "A Future That Works: Automation, Employment, and Productivity"
    author: McKinsey Global Institute
  - id: ev-mckinsey-mgi-economic-potential-2023-genai-time-share
    resource: "https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier"
    title: "The economic potential of generative AI: The next productivity frontier"
    author: McKinsey (McKinsey Global Institute)
  - id: ev-mckinsey-social-economy-2012-information-search
    resource: "https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-social-economy"
    title: "The Social Economy: Unlocking Value and Productivity Through Social Technologies"
    author: McKinsey Global Institute
  - id: ev-deloitte-intelligent-automation-2022-process-intelligence-discovery
    ...
    author: Deloitte
  - id: ev-hammer-1990-paving-cow-paths-eat
  ...
  - id: ev-mckinsey-state-of-ai-2025-workflow-redesign
    ...
    author: McKinsey
  - id: ev-mckinsey-state-of-ai-2026-workflow-redesign-highperf
  ...
  - id: ev-peng-copilot-rct-2023-speedup
    ...
    author: Peng et al.
  - id: ev-mckinsey-transformations-2021-success-rate
    resource: "https://www.mckinsey.com/capabilities/people-and-organizational-performance/our-insights/successful-transformations"
    title: The science behind successful organizational transformations
    author: McKinsey
  ...
  - id: ev-prosci-correlation-2023-cm-quality-objectives
    resource: "https://www.prosci.com/resources/articles/change-management-correlation-to-project-success"
    title: The Correlation Between Change Management and Project Success
    author: Prosci
  - id: ev-wef-future-of-jobs-2025-training-need
    resource: "https://www.weforum.org/publications/the-future-of-jobs-report-2025/"
    title: The Future of Jobs Report 2025
    author: World Economic Forum
  - id: ev-wef-future-of-jobs-2025-skill-disruption
    resource: "https://www.weforum.org/publications/the-future-of-jobs-report-2025/"
    title: Future of Jobs Report 2025
    author: World Economic Forum
  - id: ev-mckinsey-superagency-2025-leader-perception-gap
  ...
  - id: ev-mckinsey-rewiring-2025-kpi-tracking
    ...
    title: "The State of AI: How Organizations Are Rewiring to Capture Value"
    author: McKinsey
  - id: ev-wavestone-global-ai-survey-2025-no-roi-framework
    resource: "https://www.wavestone.com/en/insight/global-ai-survey-2025-ai-adoption/"
    title: "Global AI Survey 2025: The paradox of AI adoption"
    author: Wavestone
  - id: ev-deloitte-state-genai-2024-measure-impacts-struggle
    resource: "https://www.deloitte.com/us/en/about/press-room/state-of-generative-ai-Q3.html"
    title: "The State of Generative AI in the Enterprise: Now decides Next (Q3)"
    author: Deloitte
  - id: ev-deloitte-state-genai-2024-cfo-reports
    resource: "https://www.deloitte.com/us/en/about/press-room/state-of-generative-ai-Q3.html"
    title: "The State of Generative AI in the Enterprise: Now decides Next (Q3)"
    author: Deloitte
  - id: ev-mckinsey-promising-to-productive-2024-telecom-care
    resource: "https://www.mckinsey.com/capabilities/operations/our-insights/from-promising-to-productive-real-results-from-gen-ai-in-services"
    title: "From promising to productive: Real results from gen AI in services"
    author: McKinsey
  - id: ev-deloitte-state-genai-2024-roi-expectations
    resource: "https://www.deloitte.com/us/en/about/press-room/state-of-generative-ai.html"
    title: "State of Generative AI in the Enterprise (Q4 / Wave 4: Generating a New Future)"
    author: Deloitte
  ...
  - id: ev-deloitte-global-rpa-survey-2018-scaling
    ...
    author: Deloitte
  - id: ev-dain-studios-2026-agent-framework-phases
    resource: "https://dainstudios.com/insights/from-agents-to-transformation/"
    title: "How to Start and Scale Agentic AI: A.G.E.N.T. + 6-Step Strategy"
    author: DAIN Studios
  - id: ev-servicenow-2026-agent-method-phases
    resource: "https://www.servicenow.com/community/ceg-ai-coe-articles/the-a-g-e-n-t-method-a-practical-framework-for-designing-ai/ta-p/3509219"
    title: "The A.G.E.N.T. Method: A Practical Framework for Designing AI Agent Use Cases on ServiceNow"
    author: ServiceNow (community contributor)
  - id: ev-hdsr-2026-agentic-ai-intensive-faculty
    resource: "https://live.hdsrcourses.org/agentic-ai-intensive"
    title: Agentic AI Intensive course page
    author: Harvard Data Science Initiative / Next Gen Learning
# okf:generated:end
---
...
The goal of Phase 2 is a redesigned workflow — not the old workflow with an AI step bolted on. This distinction matters a great deal, although the evidence behind it is correlational rather than causal.

### Don't pave the cow path

The instinct under deadline pressure is to take the existing process and insert AI wherever a step looks automatable. This is "paving the cow path": formalizing an inefficient route instead of asking whether the route should exist at all. Michael Hammer used the phrase in his 1990 case for reengineering: "It is time to stop paving the cow paths" ([Hammer, 1990](#ev-hammer-1990-paving-cow-paths-eat)).

The modern evidence is correlational. McKinsey's 2025 State of AI survey tested 25 organizational attributes. **Fundamentally redesigning workflows was the one most correlated with self-reported EBIT impact from generative AI** ([McKinsey, 2025](#ev-mckinsey-state-of-ai-2025-workflow-redesign)). Yet only about 21% of organizations using gen AI said they had fundamentally redesigned even some workflows ([McKinsey, 2025](#ev-mckinsey-state-of-ai-2025-workflow-redesign)). The 2026 edition shows the same pattern among self-identified high performers ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-workflow-redesign-highperf)).

Neither survey shows that redesign causes the gains. In a study of a staggered AI rollout to customer-support agents, adding AI to the existing workflow also produced measured gains ([Brynjolfsson, Li & Raymond, 2023](#ev-brynjolfsson-generative-ai-at-work-2023-productivity)). [Rethink the Process, or Just Add AI?](/research-notes/rethink-the-process-or-just-add-ai.md) weighs the evidence on both sides, including the record of 1990s reengineering.
...
**Automating a bad process.** The most expensive mistake. Lift-and-shift automation of an unstandardized, inefficient workflow magnifies the inefficiency and locks it in. *Avoid it:* standardize and redesign before you automate; deprioritize any candidate that isn't yet stable (Phase 1).

**Bolting AI on instead of redesigning.** In McKinsey's 2025 study, workflow redesign was the attribute most correlated with EBIT impact, yet only ~21% of gen-AI users had done it ([McKinsey, 2025](#ev-mckinsey-state-of-ai-2025-workflow-redesign)). Inserting an AI step into the old flow often captures only part of the available value. *Avoid it:* design the target-state workflow first (Phase 2).
