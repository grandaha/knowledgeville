...
The separation is stark. More than 60% of "future-built" (leading) firms rigorously track AI value, versus only 17% of stagnating firms — roughly a 3.5x gap in measurement discipline ([BCG, 2025](#ev-bcg-value-gap-2025-track-value-leaders-laggards)). That discipline maps to results: future-built firms generate 1.7x more revenue growth and 1.6x higher EBIT margins than laggards ([BCG, 2025](#ev-bcg-value-gap-2025-leader-premium)). And the leading cohort is small — only 5% of companies are future-built, while roughly 60% have not achieved material value ([BCG, 2025](#ev-bcg-value-gap-2025-distribution)). The same shape appears in McKinsey's data, where about 6% are "AI high performers" attributing 5% or more of EBIT to AI ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-high-performers)).
