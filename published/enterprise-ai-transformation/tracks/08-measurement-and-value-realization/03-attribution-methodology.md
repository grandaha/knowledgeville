...
sources:
  ...
  - id: ev-peng-copilot-rct-2023-speedup
    ...
    author: Peng et al.
  - id: ev-brynjolfsson-generative-ai-at-work-2025-did-productivity
    resource: "https://academic.oup.com/qje/article/140/2/889/7990658"
    title: Generative AI at Work (Quarterly Journal of Economics)
  ...
  - id: ev-deloitte-state-genai-2024-cfo-reports
    ...
    title: "The State of Generative AI in the Enterprise: Now decides Next (Q3)"
    author: Deloitte
  - id: ev-forrester-tei-methodology-framework
    resource: "https://www.forrester.com/policies/tei/"
    title: Total Economic Impact (TEI) Methodology
    author: Forrester
...
Most organizations are stuck at the coincidence stage. Only 37% attribute *any* level of EBIT impact to AI, so roughly six in ten cannot tie any EBIT to AI at all ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-ebit-any)). Only about 6% qualify as high performers who attribute 5% or more of EBIT to it ([McKinsey, 2026](#ev-mckinsey-state-of-ai-2026-high-performers)). Other surveys are just as stark: 60% of companies achieve little or no value from AI, and only about 5% achieve value at scale ([BCG, 2025](#ev-bcg-value-gap-2025-distribution)). Gartner projected that at least 30% of gen-AI projects would be abandoned after proof of concept by the end of 2025, citing unclear business value among the causes ([Gartner, 2024](#ev-gartner-genai-poc-2024-abandonment)). And in one of the bluntest findings, 95% of enterprise gen-AI pilots delivered no measurable P&L impact ([MIT Project NANDA, 2025](#ev-mit-nanda-genai-divide-2025-no-pl-impact)).
