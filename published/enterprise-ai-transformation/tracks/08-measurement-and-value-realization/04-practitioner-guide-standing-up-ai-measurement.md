...
sources:
  ...
  - id: ev-deloitte-state-genai-2024-cfo-reports
    ...
    title: "The State of Generative AI in the Enterprise: Now decides Next (Q3)"
    author: Deloitte
  - id: ev-google-gsm-heart-2010-framework
    resource: "https://research.google/pubs/measuring-the-user-experience-on-a-large-scale-user-centered-metrics-for-web-applications/"
    title: Measuring the User Experience on a Large Scale (CHI 2010)
    author: "Google (Rodden, Hutchinson, Fu)"
  - id: ev-amplitude-north-star-metric-framework
    resource: "https://amplitude.com/books/north-star/about-north-star-framework"
    title: The North Star Playbook
    author: Amplitude
  - id: ev-mcclure-aarrr-pirate-metrics-2007-framework
    resource: "https://500hats.typepad.com/500blogs/2007/09/startup-metrics.html"
    title: "Startup Metrics for Pirates: AARRR!"
    author: Dave McClure (500 Startups)
  - id: ev-dora-four-keys-framework
    resource: "https://dora.dev/guides/dora-metrics-four-keys/"
    title: DORA software delivery performance metrics (Four Keys)
    author: DORA / Google Cloud
  - id: ev-forsgren-space-2021-framework
    resource: "https://queue.acm.org/detail.cfm?id=3454124"
    title: The SPACE of Developer Productivity (ACM Queue 19(1))
    author: Forsgren et al.
  - id: ev-dx-core-4-2024-framework
    resource: "https://newsletter.getdx.com/p/introducing-the-dx-core-4"
    title: Introducing the DX Core 4
    author: DX
  ...
  - id: ev-peng-copilot-rct-2023-speedup
    ...
    author: Peng et al.
  - id: ev-cooper-stage-gate-framework
    resource: "https://www.stage-gate.com/blog/the-stage-gate-model-an-overview/"
    title: The Stage-Gate Idea-to-Launch System
    author: Robert G. Cooper / Stage-Gate International
  - id: ev-ries-lean-startup-2011-build-measure-learn
    resource: "https://theleanstartup.com/book"
    title: The Lean Startup
    author: Eric Ries
  - id: ev-teller-google-x-2016-celebrate-killing
    resource: "https://www.ted.com/talks/astro_teller_the_unexpected_benefit_of_celebrating_failure"
    title: The unexpected benefit of celebrating failure (TED)
    author: "Astro Teller (X / Google X), TED"
# okf:generated:end
---

Most AI programs measure too late, too little, or not at all. Fewer than one in five organizations track well-defined KPIs for their gen-AI solutions — and KPI tracking is among the practices most correlated with bottom-line impact ([McKinsey, 2025](#ev-mckinsey-rewiring-2025-kpi-tracking)). The cost of that gap shows up downstream: only 47% of IT decision-makers say their company is currently achieving positive ROI from its AI projects ([IBM, 2024](#ev-ibm-ai-roi-2024-positive-roi)), only about 5% of companies are achieving AI value at scale ([BCG, 2025](#ev-bcg-value-gap-2025-distribution)), and Gartner reports that at least 50% of gen-AI projects were abandoned after proof of concept by the end of 2025, driven by poor data quality, weak risk controls, escalating cost, and unclear value ([Gartner, 2026](#ev-gartner-genai-failure-2026-half-abandoned)). Measurement is what lets you catch those failures early and reallocate before the money is gone.
