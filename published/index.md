...
**Feed it to your AI agent** — the entire knowledge base is available as a [public GitHub repository](https://github.com/grandaha/knowledgeville), structured in a format AI tools understand natively. Clone it, add it to a Claude Project, or point any AI assistant at it. You get curated, validated research as context rather than generic training data.
...
- **Benchmark your organization** with the [AI Transformation Maturity Self-Assessment](https://www.onesteplabs.com/maturity-assessment.html) — score all eight tracks against the framework's rubrics, see your binding constraint, and get a recommended sequence.
