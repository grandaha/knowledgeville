...
* **Creation**: new bundle — a plain-language guide to the Open Knowledge Format for knowledge and strategy leaders, opening with [What OKF Is](/open-knowledge-format/what-okf-is.md).
* **Creation**: two themes — [Understanding OKF](/open-knowledge-format/01-understanding-okf/index.md) (the format as it stands today) and [The Potential](/open-knowledge-format/02-the-potential/index.md) (our grounded read of where it could go).
