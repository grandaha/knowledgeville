...
* **Update**: [The Team Second Brain](/team-second-brain/the-team-second-brain.md) adds a new
  ...
  projects built on the LLM Wiki pattern with real adoption (Khoj alone at 35,000+ stars),
  against almost no comparable team-shared attempts — including one real, well-designed
  system that drew zero adoption. Grounds the bundle's core gap in concrete, searchable
  evidence rather than a handful of anecdotal examples.
* **Update**: [The Team Second Brain](/team-second-brain/the-team-second-brain.md) corrects
  an overstated claim that every real implementation of the LLM Wiki pattern stops at one
  person. Granola already runs a team-shared version for meeting transcripts specifically,
  and Meta is internally piloting a team-level layer ("Third Brain") across dozens of teams.
  The gap this bundle addresses is narrowed to the general case: a shared wiki built from
  everything a team's AI use touches, not one input type.
